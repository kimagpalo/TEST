...
GlobalVariable.str = WebUI.getAttribute(findTestObject('Object Repository/common/a_idGeneric', ['id' : 'CRM_CUSTOM_CARD_GROWTHPROGRAM_C_0']), 'text')
KeywordUtil.logInfo('Object to be tested is: ' + GlobalVariable.str)

WebUI.click(findTestObject('Object Repository/common/a_idGeneric', ['id' : 'CRM_CUSTOM_CARD_GROWTHPROGRAM_C_0']))

// call datafile
excelData = findTestData('Data Files/Product Hierarchy - Testing')
int rowNum = excelData.getRowNumbers()

// Click Create Growth Program button
