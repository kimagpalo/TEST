...
GlobalVariable.str = WebUI.getAttribute(findTestObject('Object Repository/common/a_idGeneric', ['id' : 'CRM_CUSTOM_CARD_GLOBALPROGRAM_C_0']), 'text')
KeywordUtil.logInfo('Object to be tested is: ' + GlobalVariable.str)

WebUI.click(findTestObject('Object Repository/common/a_idGeneric', ['id' : 'CRM_CUSTOM_CARD_GLOBALPROGRAM_C_0']))

// call datafile
excelData = findTestData('Data Files/Product Hierarchy - Testing')
int rowNum = excelData.getRowNumbers()

// Click Create Global Program button
WebUI.click(findTestObject('Object Repository/common/btn_Generic', ['text' : 'Create']))
WebUI.delay(5)

WebUI.waitForElementVisible(findTestObject('Object Repository/common/a_titleGeneric', ['title' : 'Search: Primary Product']), 5)
WebUI.click(findTestObject('Object Repository/common/a_titleGeneric', ['title' : 'Search: Primary Product']))
WebUI.delay(3)
...
WebUI.click(findTestObject('Object Repository/common/btn_Generic', ['text' : 'ancel']))
WebUI.delay(3)

// close opportunity
WebUI.click(findTestObject('Object Repository/common/btn_idContainsGeneric', ['id' : 'CancelBtn11']))
WebUI.delay(3)
